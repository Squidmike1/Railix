  ...
  const principles = [
    {
      ...
      description: "Streamlined integration for businesses and developers. Connect to Railix infrastructure through a guided, compliance-ready onboarding flow.",
      align: "left",
    },
    {
      number: "02",
      titleParts: [
        ...
        { text: " INITIATION", highlight: false },
      ],
      description: "Programmatic payment initiation through clean, well-documented APIs. Support for multiple currencies, methods, and settlement paths.",
      align: "right",
    },
    {
      number: "03",
      titleParts: [
        { text: "CONTROLS ", highlight: false },
        { text: "& SCREENING", highlight: true },
      ],
      description: "Built-in compliance controls and risk screening at every transaction layer. Automated checks before settlement proceeds.",
      align: "left",
    },
    {
      number: "04",
      titleParts: [
        ...
        { text: "& RECONCILIATION", highlight: true },
      ],
      description: "Final settlement with full auditability and real-time reconciliation. Transparent reporting for every movement of value.",
      align: "right",
    },
  ]
