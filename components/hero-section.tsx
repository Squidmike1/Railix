      ...
      <div ref={contentRef} className="flex-1 w-full">
        <SplitFlapAudioProvider>
          <div className="relative">
            <SplitFlapText text="RAILIX" speed={80} />
            <div className="mt-4">
              <SplitFlapMuteToggle />
            </div>
          </div>
        ...
        <p className="mt-12 max-w-lg font-mono text-sm text-muted-foreground leading-relaxed">
          Railix is developing next-generation payment rails for digital commerce&mdash;designed for speed, transparency, and a compliance-first foundation.
        </p>
        ...
        <div className="mt-16 flex items-center gap-8">
          ...
          >
            <ScrambleTextOnHover text="Request Early Access" as="span" duration={0.6} />
