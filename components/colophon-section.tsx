      ...
      <div ref={gridRef} className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 md:gap-12">
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li className="font-mono text-xs text-foreground/80">Railix Inc.</li>
            <li className="font-mono text-xs text-foreground/80">Fintech Infrastructure</li>
          </ul>
        </div>
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li className="font-mono text-xs text-foreground/80">Under Development</li>
            <li className="font-mono text-xs text-accent">Launching Soon</li>
          </ul>
        </div>
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li className="font-mono text-xs text-foreground/80">Montana</li>
            <li className="font-mono text-xs text-foreground/80">United States</li>
          </ul>
        </div>
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li>
              <a
                href="mailto:compliance@railixpay.com"
                className="font-mono text-xs text-foreground/80 hover:text-accent transition-colors duration-200"
              >
                compliance@railixpay.com
              </a>
            </li>
          </ul>
        </div>
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            ...
            <li className="font-mono text-xs text-foreground/80">Pre-Launch</li>
          </ul>
        </div>
      </div>
