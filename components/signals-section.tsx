...
const signals = [
  {
    ...
    note: "Legacy payment rails are fragmented across regions, currencies, and institutions\u2014creating friction for global commerce.",
  },
  {
    date: "Challenge",
    title: "Settlement Gaps",
    note: "Global commerce needs clearer settlement pathways. Current infrastructure lacks transparency and real-time reconciliation.",
  },
  {
    date: "Approach",
    title: "Infrastructure First",
    note: "Railix is building infrastructure-first foundations\u2014programmable rails designed for the next era of digital value movement.",
  },
  {
    date: "Vision",
    title: "Compliance Native",
    note: "Embedding compliance and risk controls at the protocol layer, not as an afterthought bolted onto legacy systems.",
  },
  {
    date: "Outcome",
    title: "Builder Platform",
    note: "An API-first platform enabling developers and enterprises to build on modern, transparent payment infrastructure.",
  },
]
  ...
  return (
    <section id="signals" ref={sectionRef} className="relative py-32 pl-6 md:pl-28">
      ...
      <div ref={headerRef} className="mb-16 pr-6 md:pr-12">
        ...
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">WHY PAYMENT RAILS NEED AN UPGRADE</h2>
      </div>
